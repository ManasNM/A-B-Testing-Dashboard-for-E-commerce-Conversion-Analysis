...
page (Control) for an e-commerce platform.
...
- Conversion Event: User completes a desired action (converted = 1)
...
🧠 Project Type:
Data Science | Experimentation | A/B Testing | Business Analytics
